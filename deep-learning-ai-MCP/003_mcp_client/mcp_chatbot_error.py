"""
Error: Error code: 400 - {'type': 'error', 'error': {'type': 'invalid_request_error', 'message': 'messages.5: tool_use ids were found without tool_result blocks immediately after: toolu_01Ahoi5mqQUW3WqzhDpCJkPN. Each tool_use block must have a corresponding tool_result block in the next message.'}, 'request_id': 'req_011CaSsK2soE9DGZmYpEP9w6'}

Claude 一轮返回了多个 tool_use，但你的代码每处理一个 tool 就立刻重新调用 Claude，导致剩下的 tool_use 没有对应的 tool_result。
"""
...
class MCP_ChatBot:
    ...
    async def connect_to_server_and_run(self):
        ...
        async with (
            ...
            # ! Initialize the connection ↔️ (1:1 connection with the server)
            # ! Establish the handshake 🤝🏻 and initialize the session
            ...
            # ! Assign this to a self variable
